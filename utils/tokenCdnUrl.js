...
function signUrl(url, securityKey=TOKEN, expirationTime = 30, userIp, isDirectory = false, pathAllowed="/", countriesAllowed, countriesBlocked) {
	/*
